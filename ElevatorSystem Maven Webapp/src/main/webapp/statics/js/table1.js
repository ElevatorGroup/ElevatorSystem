layui.use(['table', 'layer','element', 'laydate'], function(){
    ...
    $('.addServer').on('click',function(){
        layer.open({
            title: '添加维保人员'
            ,content: '<form action="" method="post" class="addSaa" novalidate="novalidate">       <div class="elevatorInfo-wr addStaff-wr"> 
            	<div class="elevatorInfo-item"><div class="elevatorInfo-item-bd clearfix">  <div class="form-group">            
            	<label for="name" class=" control-label">姓名</label>  <input type="text" name="name" class="form-control">  </div> 
            	<div class="form-group">            <label for="sex" class=" control-label">性别</label> 
            	<div class="selectAre"><span class="slectSex"><input type="radio" name="sex" value="男" title="男" checked="">男</span><span class="slectSex"><input type="radio" name="sex" value="女" title="女">女</span></div> 
            	</div><div class="form-group">          
            	<label for="age" class=" control-label">年龄</label> 
<input type="text" name="age" class="form-control">  </div><div class="form-group">          
<label for="phone" class=" control-label">手机号码</label>  <input type="text" name="phone" class="form-control"> 
</div><div class="form-group">      
