        ...
        var $ = layui.$, active = {
            getCheckLength: function(){ //获取选中数目
                ...
                if(data.length>0){
                    layer.open({
                        title: '分配物业人员',
                        content: "<select id='custom-headers' multiple='multiple'>
                        
                        <option value='elem_1'>elem 1</option><option value='elem_2'>elem 2</option>
                        <option value='elem_3'>elem 3</option><option value='elem_4'>elem 4</option>
                        ... <option value='elem_100'>elem 100</option></select><script>$('#custom-headers').multiSelect();</script>"
                        ,area: '410px'
                    });
                }else{
                    alert("请至少选择一位物业人员")
